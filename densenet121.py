...
def DenseNet(nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.0, dropout_rate=0.0, weight_decay=1e-4, classes=1000, weights_path=None):
    ...
    # x = Conv2D(nb_filter, (7, 7), strides=(2, 2), name='conv1', bias=False)(x)
...
def conv_block(x, stage, branch, nb_filter, dropout_rate=None, weight_decay=1e-4):
    ...
    x=Conv2D(inter_channel,(1,1),activation='relu',padding='same',name=conv_name_base+'_x1',use_bias=False)(x)
    ...
    x=Conv2D(nb_filter,(3,3),activation='relu',padding='same',name=conv_name_base+'_x2',use_bias=False)(x)
...
def transition_block(x, stage, nb_filter, compression=1.0, dropout_rate=None, weight_decay=1E-4):
    ...
    x=Conv2D(int(nb_filter * compression),(1,1),activation='relu',padding='same',name=conv_name_base,use_bias=False)(x)
